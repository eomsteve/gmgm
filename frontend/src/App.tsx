      ...
      <Routes>
        <Route path="/" element={<NavBtn />}>
          ...
          <Route path="favorite" element={<Favorite />}>
            <Route
              index
              element={isLogin ? <FavoriteIndexPage /> : <LogInPage />}
            ></Route>
          </Route>
          <Route
            path="checkLists"
            element={isLogin ? <CheckLists /> : <LogInPage />}
          ></Route>
          <Route
            path="checkLists/:checklistId"
            element={isLogin ? <CheckList /> : <LogInPage />}
          ></Route>
          <Route
            path="/detail/product/:productId/business/:businessType"
            element={isLogin ? <DetailPage /> : <LogInPage />}
          ></Route>
          <Route
            path="/detail/product/:productId/goods/:goodsId/business/:businessType"
            element={isLogin ? <DetailPage /> : <LogInPage />}
          ></Route>
