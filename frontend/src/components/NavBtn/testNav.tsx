		...
		<ul className="fab-options">
			...
			<li onClick={() => {onClickHandle()}}>
				...
				<div className="fab-icon-holder">
					<i className="fas fa-video"><CheckList width="70%" height="70%"/></i>
				</div>
			</li>
			<li onClick={() => navigate('/favorite')}>
				<span className="fab-label">즐겨찾기 페이지</span>
				<div className="fab-icon-holder">
					<i className="fas fa-comments"><Favorite width="90%" height="90%" /></i>
				</div>
			</li>
			<li onClick={() => navigate('/')}>
				<span className="fab-label">홈 화면</span>
				<div className="fab-icon-holder ">
					<i className=""><Home width="70%" height="70%" /></i>
				</div>
			</li>
		</ul>
	</div>
